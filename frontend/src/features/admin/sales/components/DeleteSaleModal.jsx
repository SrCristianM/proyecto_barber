...
export default function DeleteSaleModal({ clientName, total, onConfirm, onClose }) {
  return (
    <Modal title="Confirmar Eliminación" onClose={onClose}>
      <div className="space-y-4">
        ...
        <p className="text-center text-foreground">
          ¿Estás seguro de que deseas eliminar la venta de <strong>{clientName}</strong> por un total de{" "}
