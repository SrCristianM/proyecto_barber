          ...
          <div className="flex items-center justify-between p-4 sm:p-5 bg-secondary/30 rounded-2xl border border-border/60">
            ...
            <div className="flex items-center gap-2.5">
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 bg-primary/10 text-primary border border-primary/20 hover:bg-primary/20 rounded-xl transition-all text-xs font-semibold cursor-pointer shadow-2xs"
              >
