...
export default function DeleteScheduleModal({ barberName, day, onConfirm, onClose }) {
  return (
    <Modal title="Confirmar Eliminación" onClose={onClose}>
      <div className="space-y-4">
        ...
        <p className="text-center text-foreground">
          ¿Estás seguro de que deseas eliminar el horario de <strong>{barberName}</strong> para el día <strong>{day}</strong>?
        </p>
