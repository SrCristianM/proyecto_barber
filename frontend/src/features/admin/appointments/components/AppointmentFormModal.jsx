    ...
    >
      ...
      >
        ...
        {formData.id_servicio && (() => {
          ...
          return svc ? (
            <div className="flex items-center justify-between p-4 bg-secondary/40 border border-border/60 rounded-xl">
              <span className="text-sm text-muted-foreground font-medium">Precio total del servicio</span>
              <span className="text-base font-bold text-primary">${Number(svc.precio).toLocaleString()}</span>
            </div>
          ) : null;
        })()}
